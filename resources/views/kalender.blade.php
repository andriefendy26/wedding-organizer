...
<div class="bg-white dark:bg-gray-800 min-h-screen">
    ...
    <!-- Main Content -->
    <div class="px-30 py-12 bg-white dark:bg-gray-800">
        ...
        <div class="max-w-6xl mx-auto mt-16 mb-8">
            <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-center text-white shadow-xl">
                <h3 class="text-3xl font-semibold edu-vic-wa-nt-hand-500 mb-4">Butuh Konsultasi?</h3>
                <p class="text-lg pt-serif-regular-italic mb-6 opacity-90">Hubungi kami untuk diskusi lebih lanjut tentang acara impian Anda</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <button id="whatsappContactBtn" class="flex group hover:scale-105 transition-all duration-300 bg-white text-purple-600 rounded-xl justify-center items-center py-3 px-6 shadow-lg hover:shadow-xl">
                        <span class="poppins-regular font-semibold">WhatsApp</span>
                        <svg class="w-5 h-5 ml-2 group-hover:rotate-12 transition-transform duration-300" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <button id="phoneContactBtn" class="flex group hover:scale-105 transition-all duration-300 bg-transparent border-2 border-white text-white rounded-xl justify-center items-center py-3 px-6 hover:bg-white hover:text-purple-600">
                        <span class="poppins-regular font-semibold">Telepon</span>
