    ...
    <div class="px-10 lg:px-32 py-12 bg-white dark:bg-gray-800">
        ...
        <div class="max-w-6xl mx-auto mt-16 mb-8">
            <div class="bg-gradient-to-r from-purple-600 to-pink-600 rounded-2xl p-8 text-center shadow-xl">
                <h3 class="text-3xl font-semibold edu-vic-wa-nt-hand-500 mb-4 text-black dark:text-white ">Butuh Konsultasi?</h3>
                <p class="text-lg pt-serif-regular-italic mb-6 opacity-90 text-gray-700 dark:text-gray-300 ">Hubungi kami untuk diskusi lebih lanjut tentang acara impian Anda</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    ...
                    <button id="phoneContactBtn" class="flex group hover:scale-105 transition-all duration-300 bg-transparent border-2 border-black dark:border-white dark:text-white rounded-xl justify-center items-center py-3 px-6 hover:bg-white hover:text-[#B2110E] shadow-lg hover:shadow-xl">
